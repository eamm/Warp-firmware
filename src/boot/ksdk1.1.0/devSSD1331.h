...
void	resetRect(int startCol, int startRow, int endCol, int endRow, int blue, int green, int red);
void	drawChar(int startCol, int startRow, char chr);
void	drawLine(int startCol, int startRow, int endCol, int endRow);
